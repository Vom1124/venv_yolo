...
<p><u>Warning:</u> This installation might be much longer than installing direclty with .whl file&mdasharound 3 hours, so allocate enough resources for the VM to begin with. Also, make sure to uninstall
